...
![Captura de ecrã 2026-09-02, às 21.06.26.png](Report/Captura_de_ecra_2026-09-02_as_21.06.26.png)

![Captura de ecrã 2026-09-02, às 21.08.40.png](Report/Captura_de_ecra_2026-09-02_as_21.08.40.png)

![Captura de ecrã 2026-09-02, às 21.18.20.png](Report/Captura_de_ecra_2026-09-02_as_21.18.20.png)

![Captura de ecrã 2026-09-02, às 21.18.26.png](Report/Captura_de_ecra_2026-09-02_as_21.18.26.png)
...
- **Local Account Creation, Privilege Escalation & Account Access Removal (MITRE T1136.001 / T1098 / T1531):** A user account (`student1`) was created, added to the local `Administrators` group, and subsequently deleted.
    ...
    ![Captura de ecrã 2026-09-02, às 21.37.33.png](Report/ca398ef3-0225-4002-a666-110e0448f899.png)
...
- **Sensitive File Access & Local Data Staging (MITRE T1552.001 / T1074.001):** Inspection of `/etc/passwd` on the Linux target and redirection of its content to a staging file (`/tmp/loot.txt`).
    ...
    ![Captura de ecrã 2026-09-03, às 11.20.16.png](Report/Captura_de_ecra_2026-09-03_as_11.20.16.png)
    

![Captura de ecrã 2026-09-03, às 11.20.23.png](Report/Captura_de_ecra_2026-09-03_as_11.20.23.png)
...
![Captura de ecrã 2026-09-02, às 22.18.14.png](Report/Captura_de_ecra_2026-09-02_as_22.18.14.png)

![Captura de ecrã 2026-09-02, às 22.18.21.png](Report/Captura_de_ecra_2026-09-02_as_22.18.21.png)
...
- **Detection Controls & Active Response Validation:** Implementation of File Integrity Monitoring (**FIM**), custom detection rules (`local_rules.xml`), and dynamic containment via Wazuh Active Response (`firewall-drop` via `iptables`).
    - **FIM**: verified real-time integrity alerts for file creation, modification, and deletion across monitored directories on both Windows and Linux endpoints.
        ...
        ![Captura de ecrã 2026-09-02, às 22.51.12.png](Report/Captura_de_ecra_2026-09-02_as_22.51.12.png)
        
        - Linux:
    
    ![Captura de ecrã 2026-09-02, às 22.52.03.png](Report/Captura_de_ecra_2026-09-02_as_22.52.03.png)
...
4. **Detection Engineering & Automated Mitigation:**
    ...
    ![Captura de ecrã 2026-09-03, às 14.18.05.png](Report/Captura_de_ecra_2026-09-03_as_14.18.05.png)
    ...
    ![Captura de ecrã 2026-09-03, às 14.19.16.png](Report/Captura_de_ecra_2026-09-03_as_14.19.16.png)
    
    - Active Response triggered `firewall-drop`, applying dynamic `iptables` drop rules against the offensive IP.
    
    ![Captura de ecrã 2026-09-03, às 14.25.16.png](Report/Captura_de_ecra_2026-09-03_as_14.25.16.png)
    
    ![Captura de ecrã 2026-09-03, às 14.21.29.png](Report/Captura_de_ecra_2026-09-03_as_14.21.29.png)
    

![Captura de ecrã 2026-09-03, às 14.30.40.png](Report/Captura_de_ecra_2026-09-03_as_14.30.40.png)

### When (When did this occur and is it still happening?)

![Captura de ecrã 2026-09-02, às 22.19.26.png](Report/Captura_de_ecra_2026-09-02_as_22.19.26.png)

- **Status:** Contained and resolved. Offensive traffic was dropped by Active Response, verified by ICMP ping timeouts.

![Captura de ecrã 2026-09-02, às 22.18.33.png](Report/Captura_de_ecra_2026-09-02_as_22.18.33.png)

![Captura de ecrã 2026-09-02, às 22.18.51.png](Report/Captura_de_ecra_2026-09-02_as_22.18.51.png)
